package me.hugo.gadgetsmenu.gadget.list;
...
public class ChickenShooterAction implements ClickAction, Listener {

    @Override
    public void execute(GadgetsMenu main, PlayerData player, ClickType type) {
        if (type.isLeftClick()) {
